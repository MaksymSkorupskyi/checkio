...
so in this mission you’ll need to learn how to use completed modules
...
def days_diff(first_date: Tuple[int, int, int],
              second_date: Tuple[int, int, int]) -> int:
    """ Find the difference in days between the given dates """
    return abs(date(*first_date) - date(*second_date)).days
